...
import com.trustpayments.sdk.model.PaymentConnector;
...
public class PaymentConnectorService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#payment-connector-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#payment-connector-service--read">Read Documentation</a>
