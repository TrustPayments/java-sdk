...
import com.trustpayments.sdk.model.DocumentTemplateType;
...
public class DocumentTemplateTypeService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#document-template-type-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#document-template-type-service--read">Read Documentation</a>
