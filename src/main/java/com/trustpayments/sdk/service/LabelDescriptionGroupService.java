...
import com.trustpayments.sdk.model.LabelDescriptorGroup;
...
public class LabelDescriptionGroupService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#label-description-group-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#label-description-group-service--read">Read Documentation</a>
