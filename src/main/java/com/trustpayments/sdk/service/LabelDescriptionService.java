...
import com.trustpayments.sdk.model.LabelDescriptor;
...
public class LabelDescriptionService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#label-description-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#label-description-service--read">Read Documentation</a>
