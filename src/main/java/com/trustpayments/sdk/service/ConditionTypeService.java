...
import com.trustpayments.sdk.model.ConditionType;
...
public class ConditionTypeService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#condition-type-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#condition-type-service--read">Read Documentation</a>
