...
import com.trustpayments.sdk.model.RefundComment;
import com.trustpayments.sdk.model.RefundCommentActive;
import com.trustpayments.sdk.model.RefundCommentCreate;
...
public class RefundCommentService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--all">Find by refund Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--create">Create Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--delete">Delete Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--pin">Pin Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--unpin">Unpin Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#refund-comment-service--update">Update Documentation</a>
