...
import com.trustpayments.sdk.model.StaticValue;
...
public class StaticValueService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#static-value-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#static-value-service--read">Read Documentation</a>
