...
import com.trustpayments.sdk.model.RenderedTerminalReceipt;
import com.trustpayments.sdk.model.ServerError;
import com.trustpayments.sdk.model.TerminalReceiptFetchRequest;
...
public class TransactionTerminalService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#transaction-terminal-service--fetch-receipts">Fetch Receipts Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#transaction-terminal-service--till-connection-credentials">Create Till Connection Credentials Documentation</a>
