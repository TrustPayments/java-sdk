...
import com.trustpayments.sdk.model.UserSpaceRole;
...
public class UserSpaceRoleService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#user-space-role-service--add-role">Add Role Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#user-space-role-service--list">List Roles Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#user-space-role-service--remove-role">Remove Role Documentation</a>
