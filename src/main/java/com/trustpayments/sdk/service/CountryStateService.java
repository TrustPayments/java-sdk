...
import com.trustpayments.sdk.model.RestCountryState;
...
public class CountryStateService {
  ...
  /**
    ...
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#country-state-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://ep.trustpayments.com/doc/api/web-service#country-state-service--country">Find by Country Documentation</a>
